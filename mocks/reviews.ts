...
export const mockReviews: Review[] = [
  {
    ...
    response: "Thank you so much! It was a pleasure working with your team. Looking forward to future events!",
    helpful: 12,
  ...
  },
  {
    ...
    response: "We're thrilled you enjoyed our service! Thank you for the wonderful review.",
    helpful: 20,
